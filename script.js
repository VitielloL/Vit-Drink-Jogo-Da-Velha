...
function gameOver(a) {
    var gameOverAlertElement = "<b>Fim de jogo </b><br><br> Jogador " + span[a].dataset.player.toUpperCase() + ' venceu !!! <br> Hora de beber ^_^ !!<br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Empatou os dois bebem ^_^ !!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
